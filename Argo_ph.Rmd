...
- Total alkalinity was not measured for MOOSE GE. TA from Moose 130 was taken in consideration for 1000 m and surface and interpolated.
...
# MOOSE GE alkalinity, used data for 0-1000 m from moose130 and interpolate.
d <- d%>%
  dplyr::mutate(ta = ifelse (Cruise=="MooseGE" & Niskin == 21, 2576.07, ifelse ( Cruise=="MooseGE" & Niskin <= 7, 2586.43,ta ))
  )
