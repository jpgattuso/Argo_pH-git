...
#MOOSE 113 and 114
if (file.exists(paste0(path, "./data/lovapm016a.RData")) == TRUE) {
  load(paste0(path, "./data/lovapm016a.RData"))
...
save(lovapm016a, file = paste0(path, "./data/lovapm016a.RData"))

#MOOSE 120
if (file.exists(paste0(path, "./data/lovapm016b.RData")) == TRUE) {
  load(paste0(path, "./data/lovapm016b.RData"))
...
save(lovapm016b, file = paste0(path, "./data/lovapm016b.RData"))
```
